...
namespace p3d {
	...
	// buffer and writing the LDR result the swapchain expects (Vulkan's
	// swapchain surface format is UNORM, not SRGB - see
	// VulkanRenderDevice.cpp's surface format selection - so gamma-encode
	// must happen here, nothing does it automatically on presentation).
