...
namespace p3d {
	...
	public:
		...
		virtual void BindVertexArray(const DeviceHandle vao);
		...
		virtual void DrawElements(const uint32 nativeDrawType, const uint32 indexCount);
		virtual void DrawElementsInstanced(const uint32 nativeDrawType, const uint32 indexCount, const uint32 instanceCount);
