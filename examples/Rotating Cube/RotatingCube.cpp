...
RotatingCube::RotatingCube() : SFMLContext(1024,768,"Pyros3D - Rotating Cube",WindowType::Close | WindowType::Resize)
{
...
void RotatingCube::Init()
{
    // Initialization
        ...
        // Create Game Object
        Cube = new GameObject();
        rCube = new RenderingComponent(AssetManager::CreateCube(30,30,30));
        Cube->Add(rCube);
