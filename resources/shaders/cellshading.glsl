...
#ifndef GLSL_CELLSHADING
#define GLSL_CELLSHADING
        ...
        void CalculateCellShading(vec3 Position, vec3 CameraPos, vec3 Normal, inout vec4 diffuse, inout vec4 specular, vec4 vs_position =vec4(0.0))
        {
            // Fragment Body
