...
static const AIToolDef kAITools[] = {
	...
	{ "set_ui",         "Set properties on an object's UI components. Rect: anchorMin/anchorMax/offsetMin/offsetMax/pivot ([x,y]). Image: tint/border ([r,g,b,a] / [l,t,r,b]), texture (path). Text: text, size, color, align, verticalAlign, wrap, sdf. Canvas: referenceWidth/referenceHeight, scaleMode, sortOrder. Button: interactable, transition, onClick, hoverTint/pressedTint/disabledTint, hoverTextColor/pressedTextColor/disabledTextColor, pressedOffset.",
		{ { "object", "string", "Object name", true },
	...
	{ "add_ui",         "Add a screen-space UI component to an object: canvas, rect, image, text or button. Image, text and button add a rect if the object has none; a button also adds an image.",
		{ { "object", "string", "Object name", true },
		  { "kind", "string", "canvas, rect, image, text or button", true },
