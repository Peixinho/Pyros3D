...
static const AIToolDef kAITools[] = {
	...
	{ "set_ui",         "Set properties on an object's UI components. Rect: anchorMin/anchorMax/offsetMin/offsetMax/pivot ([x,y]). Image: tint/border ([r,g,b,a] / [l,t,r,b]), texture (path). Text: text, size, color, align, verticalAlign. Canvas: referenceWidth/referenceHeight, scaleMode, sortOrder.",
		{ { "object", "string", "Object name", true },
