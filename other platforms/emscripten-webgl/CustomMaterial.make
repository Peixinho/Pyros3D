...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/CustomMaterialDebug.html
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_TO_CONSOLE -D_DEBUG -DEMSCRIPTEN -D_CustomMaterial -DDEMO_NAME=CustomMaterial
  ...
  EMSCRIPTEN-PRELOAD = --preload-file ../../examples/CustomMaterial/assets@../../../../examples/CustomMaterial/assets
  LDDEPS    +=
  LIBS      += $(LDDEPS)
...
$(OBJDIR)/CustomMaterial.o: ../../examples/CustomMaterial/CustomMaterial.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
