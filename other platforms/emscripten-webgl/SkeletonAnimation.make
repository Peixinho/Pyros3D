...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/SkeletonAnimationDebug.html
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_TO_CONSOLE -D_DEBUG -DEMSCRIPTEN -D_SkeletonAnimation -DDEMO_NAME=SkeletonAnimation
  ...
  EMSCRIPTEN-PRELOAD = --preload-file ../../examples/SkeletonAnimation/assets@../../../../examples/SkeletonAnimation/assets
  LDDEPS    +=
  LIBS      += $(LDDEPS)
...
ifeq ($(config),release32)
  ...
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/SkeletonAnimationRelease.html
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_DISABLE -DEMSCRIPTEN -D_SkeletonAnimation -DDEMO_NAME=SkeletonAnimation
  INCLUDES  += -I../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/SkeletonAnimation.o: ../../examples/SkeletonAnimation/SkeletonAnimation.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
