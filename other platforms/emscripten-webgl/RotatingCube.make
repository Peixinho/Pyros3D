...
ifeq ($(config),debug32)
  ...
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_TO_CONSOLE -D_DEBUG -DEMSCRIPTEN -D_RotatingCube -DDEMO_NAME=RotatingCube
  ...
  EMSCRIPTEN-PRELOAD = --preload-file ../../examples/RotatingCube/assets@../../../../examples/RotatingCube/assets
  LDDEPS    +=
  LIBS      += $(LDDEPS)
...
ifeq ($(config),release32)
  ...
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_DISABLE -DEMSCRIPTEN -D_RotatingCube -DDEMO_NAME=RotatingCube
  INCLUDES  += -I../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/RotatingCube.o: ../../examples/RotatingCube/RotatingCube.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
