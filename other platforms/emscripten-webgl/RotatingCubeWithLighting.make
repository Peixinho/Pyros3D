...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/RotatingCubeWithLightingDebug.html
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_TO_CONSOLE -D_DEBUG -DEMSCRIPTEN -D_RotatingCubeWithLighting -DDEMO_NAME=RotatingCubeWithLighting
  ...
  EMSCRIPTEN-PRELOAD = --preload-file ../../examples/RotatingCubeWithLighting/assets@../../../../examples/RotatingCubeWithLighting/assets
  LDDEPS    +=
  LIBS      += $(LDDEPS)
...
OBJECTS := \
	...
	$(OBJDIR)/CRC32.o \
	$(OBJDIR)/StringID.o \
	$(OBJDIR)/RotatingCubeWithLighting.o \
...
$(OBJDIR)/RotatingCubeWithLighting.o: ../../examples/RotatingCubeWithLighting/RotatingCubeWithLighting.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
