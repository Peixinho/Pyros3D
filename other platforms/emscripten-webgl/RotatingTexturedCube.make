...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/RotatingTexturedCubeDebug.html
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_TO_CONSOLE -D_DEBUG -DEMSCRIPTEN -D_RotatingTexturedCube -DDEMO_NAME=RotatingTexturedCube
  ...
  EMSCRIPTEN-PRELOAD = --preload-file ../../examples/RotatingTexturedCube/assets@../../../../examples/RotatingTexturedCube/assets
  LDDEPS    +=
  LIBS      += $(LDDEPS)
...
ifeq ($(config),release32)
  ...
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/RotatingTexturedCubeRelease.html
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_DISABLE -DEMSCRIPTEN -D_RotatingTexturedCube -DDEMO_NAME=RotatingTexturedCube
  INCLUDES  += -I../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/RotatingTexturedCube.o: ../../examples/RotatingTexturedCube/RotatingTexturedCube.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
