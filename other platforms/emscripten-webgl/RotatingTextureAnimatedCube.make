...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/RotatingTextureAnimatedCubeDebug.html
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_TO_CONSOLE -D_DEBUG -DEMSCRIPTEN -D_RotatingTextureAnimatedCube -DDEMO_NAME=RotatingTextureAnimatedCube
  ...
  EMSCRIPTEN-PRELOAD = --preload-file ../../examples/RotatingTextureAnimatedCube/assets@../../../../examples/RotatingTextureAnimatedCube/assets
  LDDEPS    +=
  LIBS      += $(LDDEPS)
...
ifeq ($(config),release32)
  ...
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/RotatingTextureAnimatedCubeRelease.html
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_DISABLE -DEMSCRIPTEN -D_RotatingTextureAnimatedCube -DDEMO_NAME=RotatingTextureAnimatedCube
  INCLUDES  += -I../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	...
	$(OBJDIR)/GameObject.o \
	$(OBJDIR)/TextureAnimation.o \
	$(OBJDIR)/CRC32.o \
	$(OBJDIR)/StringID.o \
	$(OBJDIR)/RotatingTextureAnimatedCube.o \
...
$(OBJDIR)/TextureAnimation.o: ../../src/Pyros3D/AnimationManager/TextureAnimation.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
...
$(OBJDIR)/RotatingTextureAnimatedCube.o: ../../examples/RotatingTextureAnimatedCube/RotatingTextureAnimatedCube.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
