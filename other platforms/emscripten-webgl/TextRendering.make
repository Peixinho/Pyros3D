...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/TextRenderingDebug.html
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_TO_CONSOLE -D_DEBUG -DEMSCRIPTEN -D_TextRendering -DDEMO_NAME=TextRendering
...
$(OBJDIR)/TextRendering.o: ../../examples/TextRendering/TextRendering.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
