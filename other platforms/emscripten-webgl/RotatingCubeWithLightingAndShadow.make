...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/RotatingCubeWithLightingAndShadowDebug.html
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_TO_CONSOLE -D_DEBUG -DEMSCRIPTEN -D_RotatingCubeWithLightingAndShadow -DDEMO_NAME=RotatingCubeWithLightingAndShadow
  ...
  EMSCRIPTEN-PRELOAD = --preload-file ../../examples/RotatingCubeWithLightingAndShadow/assets@../../../../examples/RotatingCubeWithLightingAndShadow/assets
  LDDEPS    +=
  LIBS      += $(LDDEPS)
...
ifeq ($(config),release32)
  ...
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/RotatingCubeWithLightingAndShadowRelease.html
  DEFINES   += -DUNICODE -DGLEW_STATIC -D_SDL -DLOG_DISABLE -DEMSCRIPTEN -D_RotatingCubeWithLightingAndShadow -DDEMO_NAME=RotatingCubeWithLightingAndShadow
  INCLUDES  += -I../../include
  ALL_CPPFLAGS  += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	...
	$(OBJDIR)/CRC32.o \
	$(OBJDIR)/StringID.o \
	$(OBJDIR)/RotatingCubeWithLightingAndShadow.o \
...
$(OBJDIR)/RotatingCubeWithLightingAndShadow.o: ../../examples/RotatingCubeWithLightingAndShadow/RotatingCubeWithLightingAndShadow.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
