...
namespace Fishy3D {
    ...
    SSAOEffect::SSAOEffect(const unsigned& Tex1, const unsigned& Tex2) : IEffect()
    {
        ...
        // Use Sample        
        rnm.LoadTexture("textures/rnm.png", TextureType::Texture,TextureSubType::NormalTexture);
