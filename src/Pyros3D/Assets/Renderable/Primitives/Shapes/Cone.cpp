...
namespace p3d {
	...
	Cone::Cone(const f32 radius, const f32 height, const uint32 segmentsW, const uint32 segmentsH, const bool openEnded, bool smooth, bool flip, bool TangentBitangent)
	{
		isFlipped = flip;
		isSmooth = smooth;
