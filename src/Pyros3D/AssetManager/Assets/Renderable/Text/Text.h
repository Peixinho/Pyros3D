...
namespace p3d {
    ...
    class Text : public Renderable {
        public:
            ...
            Text(Font* font, const std::string& text, const f32 &charWidth, const f32 &charHeight, const Vec4 &color = Vec4(1,1,1,1));
            Text(Font* font, const std::string& text, const f32 &charWidth, const f32 &charHeight, const std::vector<Vec4> &color);
