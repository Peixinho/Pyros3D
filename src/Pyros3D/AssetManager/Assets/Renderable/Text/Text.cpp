...
namespace p3d {
    ...
    namespace Renderables {
        ...
        Text::Text(const uint32 &Handle, const std::string& text, const f32 &charWidth, const f32 &charHeight, const Vec4 &color)
        {
        ...
        Text::Text(const uint32 &Handle, const std::string& text, const f32 &charWidth, const f32 &charHeight, const std::vector<Vec4> &colors)
        {
            this->charWidth = charWidth;
            this->charHeight = charHeight;
            this->fontHandle = Handle;
